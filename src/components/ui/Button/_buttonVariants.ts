  ...
  "rounded-full font-semibold w-fit group disabled:opacity-80 flex focus-visible:ring outline-none shadow-sm ring-offset-1 items-center capitalize transition-all active:ring",
  {
    variants: {
      variant: {
        ...
        ghost:
          "border border-transparent shadow-none focus-visible:border-zinc-700 focus-visible:bg-zinc-800 focus-visible:ring-slate-500/20 active:ring-slate-500/20",
        outline:
