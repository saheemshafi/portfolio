...
export const buttonVariants = cva(
  "rounded-md font-semibold group disabled:opacity-80 flex focus-visible:ring outline-none shadow-sm ring-offset-1 items-center capitalize transition-all active:ring",
  {
    variants: {
      variant: {
        primary:
